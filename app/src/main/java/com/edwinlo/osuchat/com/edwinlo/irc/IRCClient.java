package com.edwinlo.osuchat.com.edwinlo.irc;
...
public abstract class IRCClient{
    ...
    /**
     * The definitive version number of this release of IRCClient.
...
//            }
            Socket _socket = new Socket(hostname,port);
...
/*            if (saslUsername != null) {
 ...
 /*   public final synchronized void connect(String hostname, int port, String password) throws IOException, IrcException, NickAlreadyInUseException {
        ...
        // Attempt to join the server.
        if (password != null && !password.equals("")) {
            com.edwinlo.osuchat.com.edwinlo.irc.OutputThread.sendRawLine(this, bwriter, "PASS " + password);
        }
        String nick = this.getName();
        com.edwinlo.osuchat.com.edwinlo.irc.OutputThread.sendRawLine(this, bwriter, "NICK " + nick);
        com.edwinlo.osuchat.com.edwinlo.irc.OutputThread.sendRawLine(this, bwriter, "USER " + this.getLogin() + " 8 * :" + this.getVersion());
        ...
        // Now start the outputThread that will be used to send all messages.
        if (_outputThread == null) {
            _outputThread = new com.edwinlo.osuchat.com.edwinlo.irc.OutputThread(this, _outQueue);
            _outputThread.start();
        }
...
//    protected void onIncomingChatRequest(DccChat chat) {}
    ...
    /**
     * Gets the internal login of the IRCClient.
     *
     * @return The login of the IRCClient.
     */
    ...
    private com.edwinlo.osuchat.com.edwinlo.irc.OutputThread _outputThread = null;
...
//    private DccManager _dccManager = new DccManager(this);
    ...
    private String _name = "IRCClient";
    private String _nick = _name;
    private String _login = "IRCClient";
    private String _version = "IRCClient " + VERSION + " Java IRC Bot - www.jibble.org";
